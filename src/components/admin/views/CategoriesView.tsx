    ...
    <div className="p-4 md:p-8 bg-white min-h-[calc(100vh-80px)]" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="grid grid-cols-6 bg-[#f1f5f9] border border-[#e2e8f0] rounded-[5px]">
          ...
          <div className="px-4 py-3 border-r border-[#e2e8f0] flex items-center justify-center text-[11px] font-semibold uppercase tracking-wide text-[#475569]">Source</div>
        ...
        {categories.map((cat) => (
          <div key={cat.id} className="grid grid-cols-6 bg-white rounded-[5px] border border-[#e2e8f0] overflow-hidden hover:border-[#94a3b8] hover:shadow-sm transition-all">
            {/* Category - left aligned like ProductsView */}
            ...
            <div className="px-4 py-3 border-r border-[#e2e8f0] flex items-center justify-center">
              <span className="text-[12px] font-medium text-[#475569]">{cat.type === 'icon' ? 'Icon Library' : 'Image Upload'}</span>
            </div>
            
            {/* Products */}
            <div className="px-4 py-3 border-r border-[#e2e8f0] flex items-center justify-center">
              <span className="text-[12px] font-medium text-[#475569]">{cat.items} Items</span>
            </div>
        ...
        {categories.length === 0 && (
          <div className="bg-white rounded-[5px] border border-[#e2e8f0] p-12 text-center">
            <p className="text-[#94a3b8] text-sm">No categories found. Click "Add Category" to create one.</p>
          </div>
        )}
      </div>
    </div>
